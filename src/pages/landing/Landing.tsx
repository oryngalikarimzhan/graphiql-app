...
import AuthWelcomeController from 'features/auth/auth-welcome-controller/AuthWelcomeController';
...
import DeveloperCard from 'components/common/card/developer-card/DeveloperCard';
